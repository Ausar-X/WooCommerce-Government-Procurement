...
parser = argparse.ArgumentParser(description="Henan Chengyu Trading Co., Ltd. Product Management API")
...
REST_HST = "https://chengyutrading.com"
...
if args["Operation"] == "new":
	json_data = {}
	json_data["username"] = "YOUR_GP_USERNAME"
	json_data["pwd"] = "YOUR_GP_PASSWORD"
		...
		for URLsource in URLSource:
			...
			for URLsource2 in URLSource2:
				...
				for URLsource3 in URLSource3:
					categorypm = _base64(URLsource3.split('"')[0])
